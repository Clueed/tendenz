...
const AnimationsConfig = createContext<AnimationsConfigType>({
  variants: {
  ...
  return (
    <Accordion.Item value={entry.ticker} className="relative">
      ...
      >
        <CardBackground
          expanded={expanded}
          className="from-sky-4 to-indigo-6 -z-10 bg-gradient-to-br"
        />
  ...
  return (
    <motion.div
      className={classNames(
        "absolute top-0 left-0 w-full h-full shadow rounded-xl",
        className
      )}
