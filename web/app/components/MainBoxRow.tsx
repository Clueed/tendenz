...
export default function MainBoxRow({
  ...
  return (
    ...
    <div
      className={
        "grid w-100 grid-cols-[1.5fr_3fr]  gap-x-5 gap-y-1 items-center rounded-md py-3 px-3  cursor-pointer"
      }
    >
      ...
      <div
        className={classNames("text-lg leading-tight data-[state=closed]:line-clamp-2")}
      >
      ...
      <div className={classNames("data-[state=open]:animate-slideDown data-[state=closed]:animate-slideUp overflow-hidden")}>
        <MainBoxRowSecond
          lastClose={lastClose}
