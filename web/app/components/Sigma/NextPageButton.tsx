		...
		>
			<button
				...
				className={classNames(
					'rounded-md p-3 text-slate-12 transition-all',
					{ 'bg-slate-a2': !error },
					{
						'text-tomato-12 hover:bg-tomato-a3 hover:shadow-md': error,
					},
					{
						'hover:bg-slate-a5 hover:shadow-md': !isLoading && !error,
					},
