...
export default function SigmaCard({
  ...
  return (
    <Accordion.Item
      value={entry.ticker}
      className="relative grid grid-cols-default"
    >
      <motion.div
        className="absolute top-0 right-0 w-full h-full shadow-sm from-sky-a4 to-indigo-a5 bg-gradient-to-br -z-10 sm:rounded-xl col-span-full "
        initial={{ opacity: 0 }}
