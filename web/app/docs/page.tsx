...
function MainDocsLink({ href, text }: { href: string; text: string }) {
	return (
		<Link
			href={href}
			className="group col-start-2 flex items-center justify-between rounded-lg  bg-gradient-to-br from-slate-a2 to-slate-a3 px-10 py-8 text-4xl text-slate-12 transition-all duration-1000 @container hover:from-sky-a4 hover:to-indigo-a5 hover:shadow-xl"
		>
			<div>{text}</div>
